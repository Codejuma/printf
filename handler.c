...
/**
 * print_integer - print integer funct
 * @num: number list
 * Return: 1
 */
...
/**
 * print_binary - print binary funct
 * @num: number list
 * Return: 1
 */
...
/**
 * print_hexadecimal_low - print hexadecimal funct
 * @num: number list
 * Return: 1
 */
...
/**
 * print_hexadecimal_upp - print hexadecimal upper funct
 * @num: number list
 * Return: 1
 */
...
/**
 * print_rev_string - print reverse string funct
 * @num: number list
 * Return: 1
 */
...
/**
 * _putchar - print character funct
 * @num: number list
 * Return: 1
 */
int _putchar(char c) {
